...
public class StompClientEstorno {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			sendMessages(connection, "{ \"operacao\": \"ESTORNO\",  \"pedido\": \"A1\", \"nsu\": \"2023100300002601\" ,\"queue\":\"10513613000186:B621F871:RECEBIMENTO\" }", name, interval, count);
